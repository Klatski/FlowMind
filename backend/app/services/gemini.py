...
Жёсткие правила:
  ...
  • Сценарий обязан УЛУЧШАТЬ ликвидность: минимальный баланс после применения
    должен быть не ниже текущего. Никогда не предлагай действия, которые
    углубляют разрыв или опускают баланс ниже, чем сейчас — такой сценарий
    будет отклонён движком и не покажется пользователю.
